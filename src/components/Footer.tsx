...
export function Footer({
  ...
  return (
    <footer className="site-footer bg-[#071a35] text-white">
      <div className="site-footer__inner container grid gap-10 py-14 md:grid-cols-[1.7fr_1fr_1fr_1fr]">
        <div>
          <div className="site-footer__brand mb-4 flex items-center gap-3 text-lg font-black">
            <span className="grid h-8 w-8 place-items-center rounded-[var(--radius-ui)] bg-[var(--color-primary)] text-white">+</span>
            {companyName}
          </div>
          <p className="site-footer__summary max-w-sm text-sm leading-7 text-blue-100/75">{footerText || tagline}</p>
        </div>
        <div className="site-footer__links grid content-start gap-2 text-sm text-blue-100/80">
      ...
      <div className="site-footer__bottom border-t border-white/10 py-5">
